...
export default {
  ...
  methods: {
    ...
    getWebSite(exchange) {
      ...
      link se creo despues del objeto
      btn reemplaza por link
      - this.$set
          cosas q no se establecieron desde el principio
          o desde el objeto data
  ...
  //SIEMPRE LA ESCUCHA DE UN CAMBIO
  watch:{
    $route(){
      this.getCoin()
    }
